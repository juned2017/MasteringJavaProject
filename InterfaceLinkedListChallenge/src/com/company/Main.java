...
public class Main {
    ...
    //we changed all the LinkedList to List interface just to show how powerful interface and how extensivly java uses it
    ...
    public static void main(String[] args) {
        ...
        List<Song> playList = new Vector<>(); //first you declare it as Generic List, then when you initalize you list you pick wt type you want it to be, Vector, ArrayList, LinkedList etc.
